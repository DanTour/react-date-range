...
exports['default'] = function () {
  ...
  return {
    ...
    DayDisabled: _extends({}, defaultTheme.DayDisabled, customTheme.DayDisabled),

    DayWeekend: _extends({}, defaultTheme.DayWeekend, customTheme.DayWeekend),

    DayActiveWeekend: _extends({}, defaultTheme.DayActiveWeekend, customTheme.DayActiveWeekend),

    RangeError: _extends({}, defaultTheme.RangeError, customTheme.RangeError)
  };
};