...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function handleMouseEvent(event) {
      ...
      var onDayCellHover = _props.onDayCellHover;
    ...
    value: function getStateStyles() {
      ...
      var activeWeekend = isWeekend && isEndEdge || isWeekend && isStartEdge ? styles['DayActiveWeekend'] : {};

      return _extends({}, todayStyle, sundayStyle, specialDayStyle, inRangeStyle, hoverStyle, passiveStyle, activeStyle, selectedStyle, startEdgeStyle, endEdgeStyle, disabledStyle, weekendStyle, activeWeekend);
    }
  }, {
    key: 'getClassNames',
