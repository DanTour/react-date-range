...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function handleMouseEvent(event) {
      ...
      var onItemMouseEnter = _props.onItemMouseEnter;
    ...
    value: function getStateStyles() {
      ...
      var inHoveredRange = _props2.inHoveredRange;
      var isWeekend = _props2.isWeekend;
      var styles = this.styles;

      var hoverStyle = hover && !isInRange ? styles['DayHover'] : {};
      ...
      var inRangeStyle = isInRange || inHoveredRange ? styles['DayInRange'] : {};
      ...
      var disabledStyle = isDisabled ? styles['DayDisabled'] : {};
      var weekendStyle = isWeekend ? styles['DayWeekend'] : {};

      return _extends({}, todayStyle, sundayStyle, specialDayStyle, inRangeStyle, hoverStyle, passiveStyle, activeStyle, selectedStyle, startEdgeStyle, endEdgeStyle, disabledStyle, weekendStyle);
    }
  }, {
    key: 'getClassNames',
    value: function getClassNames(classes) {
      ...
      var inHoveredRange = _props3.inHoveredRange;
      var isWeekend = _props3.isWeekend;
      var isDisabled = _props3.isDisabled;

      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected || inHoveredRange), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayDisabled, isDisabled), _defineProperty(_classnames, classes.dayInRange, isInRange || inHoveredRange), _defineProperty(_classnames, classes.dayStartEdge, isStartEdge), _defineProperty(_classnames, classes.dayEndEdge, isEndEdge), _defineProperty(_classnames, classes.dayToday, isToday), _defineProperty(_classnames, classes.daySunday, isSunday), _defineProperty(_classnames, classes.daySpecialDay, isSpecialDay), _defineProperty(_classnames, classes.weekend, isWeekend), _classnames));
    }
  }, {
    key: 'render',
    value: function render() {
      var _props4 = this.props;
      var dayMoment = _props4.dayMoment;
      var onlyClasses = _props4.onlyClasses;
      var classNames = _props4.classNames;
