  ...
  _createClass(DateRange, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (newProps.startDate || newProps.endDate) {
        ...
        var oldOpen = _props.isOpen;
        var isRangeFixed = _props.isRangeFixed;
        var newOpen = newProps.isOpen;

        oldOpen && !newOpen && !isRangeFixed && this.setRange({
          startDate: startDate,
          endDate: startDate
        }, false, true, { isRangeFixed: !isRangeFixed });
      }
    }
  }, {
    key: 'isInRange',
    ...
    value: function render() {
      ...
      var specialDays = _props2.specialDays;
      var lang = _props2.lang;
      var disableDaysBeforeToday = _props2.disableDaysBeforeToday;
      var offsetPositive = _props2.offsetPositive;
      var shownDate = _props2.shownDate;
      var showMonthArrow = _props2.showMonthArrow;
      var rangedCalendars = _props2.rangedCalendars;
      var Arrow = _props2.Arrow;
      var maxRange = _props2.maxRange;
