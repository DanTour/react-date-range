...
var DateRange = (function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    value: function dayCellHovered(dayMoment, startDate, endDate) {
      ...
      var isRangeFixed = _state.isRangeFixed;
      var isEndDateChanging = _state.isEndDateChanging;
      var isStartDateChanging = _state.isStartDateChanging;
      var lastDateFixed = _state.lastDateFixed;
      var maxRange = this.props.maxRange;

      var isInMaxRange = Math.abs(dayMoment.diff(startDate, 'days')) <= maxRange && Math.abs(dayMoment.diff(endDate, 'days')) <= maxRange;
        ...
        (function () {
          ...
          for (var i = calendarsCount; i >= 0; i--) {
            ...
            _calendars[_method](_react2['default'].createElement(_CalendarJs2['default'], {
              ...
              classNames: classes,
              onChange: isRangeFixed ? _this.handleSelect.bind(_this) : function () {
                return _this.handleSelect.bind(_this)(range);
              },
              Arrow: Arrow,
