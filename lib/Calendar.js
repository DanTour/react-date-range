  ...
  _createClass(Calendar, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (range && range['endDate'] && !range['endDate'].isSame(range['startDate'], "day") || oldRange && !oldRange["startDate"].isSame(range["startDate"])) {
        ...
        if (isEndDateChanging || !isEndDateChanging && !isStartDateChanging) {
          return this.setState({ shownDate: range['endDate'].clone().add(offset, 'months'), isRangeError: isRangeError });
        }
        if (isStartDateChanging) {
          return this.setState({ shownDate: range['startDate'].clone().add(offset, 'months'), isRangeError: isRangeError });
        }
      }
    }
  }, {
    ...
    value: function renderMonthAndYear(classes) {
      ...
      return _react2['default'].createElement(
        ...
        showMonthArrow && shownDate.isAfter(initialDate, 'month') ? Arrow ? _react2['default'].createElement(Arrow, {
        ...
        showMonthArrow && shownDate.isBefore(maxDate, 'month') ? Arrow ? _react2['default'].createElement(Arrow, {
          onClick: this.changeMonth.bind(this, +1)
        }) : _react2['default'].createElement(
          'button',
          {
