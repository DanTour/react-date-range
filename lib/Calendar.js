  ...
  _createClass(Calendar, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (range && range['endDate'] && !range['endDate'].isSame(range['startDate'], "day") || oldRange && !oldRange["startDate"].isSame(range["startDate"])) {
        var isEndDateChanging = this.props.isEndDateChanging;

        if (isEndDateChanging) {
          this.setState({ shownDate: range['endDate'].clone().add(offset, 'months'), isRangeError: isRangeError });
        } else {
    ...
    value: function renderMonthAndYear(classes) {
      ...
      var Arrow = _props4.Arrow;
      var initialDate = _props4.initialDate;
    ...
    value: function renderDays(classes) {
      ...
      var initialDate = _props6.initialDate;
      var onDayCellHover = _props6.onDayCellHover;
    ...
    value: function render() {
      ...
      var onCalendarOver = _props7.onCalendarOver;
      var maxRange = _props7.maxRange;
